...
export class ApiConstants {
    ...
    // public static readonly HEADER_LANG = environment.apiHeaderLang;
    // public static readonly CLIENT_ID = environment.clientId;
    // public static readonly CLIENT_SECRET = environment.clientSecret;
}
